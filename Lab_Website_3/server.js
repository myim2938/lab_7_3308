...
app.get('/team_stats', function(req, res) {
	...
	var query2 = 'select count(*) as game_wins from football_games where home_score > visitor_score;';
	var query3 = 'select count(*) as game_losses from football_games where home_score < visitor_score;';
...
app.get('/player_info/post', function(req, res) {
	...
	var query3 = 'select count(*) as games from football_games where ' + player_id + ' = ANY(players);';
